...
class Regex(node.BaseNode):
    ...
    strings = attribute.AttributeDefinition(isInput=True, type="str", array=True, default=[])
    searchString = attribute.AttributeDefinition(isInput=True, type="str", default="")
